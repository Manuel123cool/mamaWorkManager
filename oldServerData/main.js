...
function showMore(e) {
    ...
    if (reSearchOn()) {
        index = studentsSearch[index].correspondingIndex
    }
...
function drawCotractCheckBox() {
    ...
    addRadioButton("HV 9x45 Min 80 €/Mon U", form)
    addRadioButton("HV 18x45 Min 140 €/Mon U", form)
    addRadioButton("HV 9x60 Min 110 €/Mon U", form)
    addRadioButton("HV 18x60 Min 200 €/Mon U", form)
    addRadioButton("HV 9x45 Min 90 €/Mon S", form)
    addRadioButton("HV 18x45 Min 175 €/Mon S", form)
    addRadioButton("HV 9x60 Min 120 €/Mon S", form)
    addRadioButton("HV 18x60 Min 225 €/Mon S", form)
...
function drawHourCostCheckBox() {
    ...
    addRadioButton("60 Euro 45 Min Unterricht", form)
    addRadioButton("70 Euro 45 Min Salutogenese", form)
    addRadioButton("80 Euro 60 Min Unterricht", form)
    addRadioButton("90 Euro 60 Min Salutogenese", form)
    addRadioButton("120 Euro 60 Min Supervision", form)
...
function downloadPDF(e) {
    window.open("http://manuel-project.de/php/sendpdf.php", "_self");
}
    ...
    xmlhttp0.addEventListener('readystatechange', (e) => {
	    ...
	    const regex = new RegExp("Could not get Data", "ig")
            if (regex.test(responseText)) {
                window.open("http://manuel-project.de/php/error.php?error=true", "_self");
            }
